...
{include file="components/_scripts_common.tpl"}
    ...
    <script>
        ...
        (function(){
            ...
            new QRCode(document.getElementById('voucherQr'),{text:voucherGenerated,width:78,height:78,colorDark:'var(--tx)',colorLight:'var(--bg)',correctLevel:QRCode.CorrectLevel.M});
        })();

        var channels = [
            {id:'QRIS2',name:'QRIS',icon:'bi-qr-code-scan'},
            {id:'MANDIRIVA',name:'Mandiri VA',icon:'bi-building'},
            {id:'BCAVA',name:'BCA VA',icon:'bi-building'},
            {id:'BNIVA',name:'BNI VA',icon:'bi-building'},
            {id:'BRIVA',name:'BRI VA',icon:'bi-building'},
            {id:'ALFAMART',name:'Alfamart',icon:'bi-shop'},
            {id:'INDOMARET',name:'Indomaret',icon:'bi-shop'},
            {id:'DANA',name:'DANA',icon:'bi-wallet2'},
            {id:'OVO',name:'OVO',icon:'bi-wallet2'},
            {id:'SHOPEEPAY',name:'ShopeePay',icon:'bi-wallet2'}
        ];
