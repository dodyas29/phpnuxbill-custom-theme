...
{include file="components/_header.tpl"}
    ...
    <div class="cw">
        ...
        <section>
            ...
            <form action="{Text::url('accounts/edit-profile-post')}" method="post" enctype="multipart/form-data">
                ...
                <div class="pr-card stg">
                    ...
                    <div class="field-wrap">
                        ...
                        <a href="{Text::url('accounts/phone-update')}" style="position:absolute;right:14px;top:50%;transform:translateY(-50%);color:var(--c1);font-size:.9rem;z-index:1"><i class="bi bi-pencil"></i></a>
                    </div>
                    {/if}
                    ...
                    <div class="field-wrap">
                        ...
                        <a href="{Text::url('accounts/email-update')}" style="position:absolute;right:14px;top:50%;transform:translateY(-50%);color:var(--c1);font-size:.9rem;z-index:1"><i class="bi bi-pencil"></i></a>
                    </div>
                    {/if}
            ...
            <div class="pr-card stg" style="margin-top:10px">
