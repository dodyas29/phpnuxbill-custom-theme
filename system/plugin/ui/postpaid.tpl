...
<link rel="stylesheet" href="{$app_url}/ui/ui_custom/customer/assets/css/style.css?v=17">
        ...
        <section>
            ...
            <div class="pp-plans-wrap" id="ppPostpaidList">
                ...
                <div class="pp-pkg">
                    ...
                    <div class="pp-pkg-price">{Lang::moneyFormat($plan['price'])}<small>per bulan</small></div>
                    <a href="{$app_url}/?_route=plugin/postpaid_verify&plan_id={$plan['id']}" class="tx-act pay">Pilih</a>
                </div>
                {/foreach}
                {else}
